      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 auto-rows-[280px] gap-4">
          {PORTFOLIO_IMAGES.map((img, i) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-[#2F3E46]/0 group-hover:bg-[#2F3E46]/10 transition-all duration-700" />
            </motion.div>
          ))}
        </div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 text-[#2F3E46] hover:text-[#D4AF37] transition-colors duration-500 group"
          >
